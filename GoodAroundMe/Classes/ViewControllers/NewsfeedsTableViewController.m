//
//  NewsfeedsTableViewController.m
//  TempName
//
...
#import "NewsfeedsTableViewController.h"
...
@interface NewsfeedsTableViewController()

@property (nonatomic, strong) NSManagedObjectContext *managedObjectContext;
@property (nonatomic, strong) Post *postToDelete;
@end

@implementation NewsfeedsTableViewController
...
{
    [self performSegueWithIdentifier:@"PostGetMedia" sender:sender];
}
    ...
    if ([segue.identifier isEqualToString:@"LikesTable"]) {
        ...
        if (post) {
            if ([segue.destinationViewController respondsToSelector:@selector(setEmail:)]) {
                [segue.destinationViewController performSelector:@selector(setEmail:) withObject:post.user.email];
            }
        }
